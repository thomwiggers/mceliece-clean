...
#define xor vec128_xor
        ...
        buf[1] = xor(buf[0], pre[0][i]);
        buf[16] = xor(buf[0], pre[4][i]);
        buf[3] = xor(buf[1], pre[1][i]);
        buf[48] = xor(buf[16], pre[5][i]);
        buf[49] = xor(buf[48], pre[0][i]);
        buf[2] = xor(buf[0], pre[1][i]);
        buf[51] = xor(buf[49], pre[1][i]);
        buf[6] = xor(buf[2], pre[2][i]);
        buf[50] = xor(buf[51], pre[0][i]);
        buf[7] = xor(buf[6], pre[0][i]);
        buf[54] = xor(buf[50], pre[2][i]);
        buf[5] = xor(buf[7], pre[1][i]);
        buf[55] = xor(buf[54], pre[0][i]);
        buf[53] = xor(buf[55], pre[1][i]);
        buf[4] = xor(buf[0], pre[2][i]);
        buf[52] = xor(buf[53], pre[0][i]);
        buf[12] = xor(buf[4], pre[3][i]);
        buf[60] = xor(buf[52], pre[3][i]);
        buf[13] = xor(buf[12], pre[0][i]);
        buf[61] = xor(buf[60], pre[0][i]);
        buf[15] = xor(buf[13], pre[1][i]);
        buf[63] = xor(buf[61], pre[1][i]);
        buf[14] = xor(buf[15], pre[0][i]);
        buf[62] = xor(buf[63], pre[0][i]);
        buf[10] = xor(buf[14], pre[2][i]);
        buf[58] = xor(buf[62], pre[2][i]);
        buf[11] = xor(buf[10], pre[0][i]);
        buf[59] = xor(buf[58], pre[0][i]);
        buf[9] = xor(buf[11], pre[1][i]);
        buf[57] = xor(buf[59], pre[1][i]);
        buf[56] = xor(buf[57], pre[0][i]);
        buf[8] = xor(buf[0], pre[3][i]);
        buf[40] = xor(buf[56], pre[4][i]);
        buf[24] = xor(buf[8], pre[4][i]);
        buf[41] = xor(buf[40], pre[0][i]);
        buf[25] = xor(buf[24], pre[0][i]);
        buf[43] = xor(buf[41], pre[1][i]);
        buf[27] = xor(buf[25], pre[1][i]);
        buf[42] = xor(buf[43], pre[0][i]);
        buf[26] = xor(buf[27], pre[0][i]);
        buf[46] = xor(buf[42], pre[2][i]);
        buf[30] = xor(buf[26], pre[2][i]);
        buf[47] = xor(buf[46], pre[0][i]);
        buf[31] = xor(buf[30], pre[0][i]);
        buf[45] = xor(buf[47], pre[1][i]);
        buf[29] = xor(buf[31], pre[1][i]);
        buf[44] = xor(buf[45], pre[0][i]);
        buf[28] = xor(buf[29], pre[0][i]);
        buf[36] = xor(buf[44], pre[3][i]);
        buf[20] = xor(buf[28], pre[3][i]);
        buf[37] = xor(buf[36], pre[0][i]);
        buf[21] = xor(buf[20], pre[0][i]);
        buf[39] = xor(buf[37], pre[1][i]);
        buf[23] = xor(buf[21], pre[1][i]);
        buf[38] = xor(buf[39], pre[0][i]);
        buf[22] = xor(buf[23], pre[0][i]);
        buf[34] = xor(buf[38], pre[2][i]);
        buf[18] = xor(buf[22], pre[2][i]);
        buf[35] = xor(buf[34], pre[0][i]);
        buf[19] = xor(buf[18], pre[0][i]);
        buf[33] = xor(buf[35], pre[1][i]);
        buf[17] = xor(buf[19], pre[1][i]);
        buf[32] = xor(buf[33], pre[0][i]);
